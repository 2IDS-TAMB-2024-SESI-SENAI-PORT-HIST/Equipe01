        ...
        class CardProfile extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
            {
              ...
              { name: 'Ária (Bachianas Brasileiras No.5)', author: 'Heitor Villa-Lobos', img: '01.png', audio: 'Villa-Lobos_ Bachianas brasileiras No. 5_ I. Aria (Cantilena) _ Adagio.mp3', duration: '5:17' }],
